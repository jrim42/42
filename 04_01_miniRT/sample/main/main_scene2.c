...
/*   Updated: 2022/09/13 21:07:12 by jrim             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_scene *scene_init(void)
{
    ...
    // obj_add(&world, object_init(CYL, cyl_init(pt_init(1, 0, -4), vt_init(1, 0, -1), 2, 3), rgb_init(0.6, 0.2, 0.8))); // world 에 구2 추가
    scene->world = world;
    lights = object_init(LIGHT_PT, light_point(pt_init(0, 0, 0), rgb_init(1, 1, 1), 0.5), rgb_init(0, 0, 0)); // 더미 albedo
